...
public class LoginController implements SessionName{
    ...
    public String logout(HttpServletRequest request, HttpServletResponse response,ModelMap modelMap, 
		...
		String kakaoN = (String)session.getAttribute("kakaoN");
    		...
    		out.println("location.href='https:/kauth.kakao.com/oauth/logout?client_id=0f0cb097cf98adc10e27d4fc3ed7f796&logout_redirect_uri=http://localhost:8085/kakao/logout'");
    		out.println("</script>");
...
//	@GetMapping("/kakao/out")
//	public ResponseEntity out(HttpSession session) {
//	session.removeAttribute("userInfo");
//	session.removeAttribute("access_Token");
//	String str ="<script>)";
//	str+="location.href='https:/kauth.kakao.com/oauth/logout?client_id=0f0cb097cf98adc10e27d4fc3ed7f796&logout_redirect_uri=http://localhost:8085/kakao/logout'</script>";
//	ResponseEntity resEnt = null;
//	HttpHeaders responHeaders = new HttpHeaders();
//	responHeaders.add("Content-Type", "text/html; charset=utf-8;");
//	resEnt = new ResponseEntity(str, responHeaders, HttpStatus.CREATED);
//	
//	return resEnt;
//	}
